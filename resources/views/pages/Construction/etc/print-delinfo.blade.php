                    ...
                    <div class="card">
                            ...
                            <div class="table-responsive">
                                    <table class="table tb-content">
                                            <thead>
                                                   ...
                                                   <td class="tb-content" colspan="4"><b>Customer/Project: </b> {{$orderinfo->Customer}}</td>  
                                                   <td class="tb-content" colspan="4"><b>Delivery DATE: </b>  {{$delinfo->delivery_date}}</td>
                                                   </tr>
                                                   <tr>
                                                   <td class="tb-content" colspan="4"><b>ORDER NO: </b> {{$orderinfo->id}}</td>
                                                   <td class="tb-content" colspan="4"><b>Order Date </b> {{$orderinfo->order_date}}</td>
                                                     
                                                   </tr>
                                                   <tr>
                                                        <td class="tb-content" colspan="4"><b>Address </b> {{$orderinfo->location}}</td>
                                                   <td class="tb-content" colspan="4"><b>Prepared by </b>{{$prepared->name}}</td>
                                                   </tr>
                                                   <tr>
                                                        <td class="tb-content" colspan="8"><b>Delivery Remarks </b> 
                                                        {{$delinfo->remarks}}
                                                        </td>
                                                   </tr>
                                            ...
                                            <td class="text-center">{{number_format($Product->mark_up,4)}}</td>
                                            <td class="text-center">{{number_format(($Product->qty * $Product->mark_up),4)}}</td>
                                                ...
                                                <td class="text-center" colspan="4">{{number_format($orderinfo->total_amount,4)}}</td>
                                                </tr>
                        ...
                        <div class="bot">
                            ...
                            <table class="tb-bot" style="width:100%;">
                                <thead>
                                <tr>
                                <td class="td-bot"><h6 style="color:black;"><span style=" font-size:15px;">Release BY:</span> {{$release->name}}</h6></td>
