            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style">
                        <li>
                            <h4 class="page-title">Construction Materials Records</h4>
                        </li>
                    </ul>
                    @include('inc.message')    
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row">
                            <div class="col-lg-6">
                                    <h2><strong>List of Materials</strong></h2>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                   ...
                                   <td class="text-center"><button type="button" onclick="matinfo(this)" value="{{$Product->id}}"
                                    class="btn btn-info btn-circle waves-effect waves-circle waves-float">
                                    <i class="material-icons">assignment</i>
                                </button>
                            <input type="hidden" value="{{asset($Product->product_image)}}" id="p{{$Product->id}}-image"></td>
                                   </tr>
                ...
                <h5 class="modal-title" id="myLargeModalLabel">Add Product</h5>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="/new/construction/material" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                ...
                .then((res) => res.json())
                    .then((data) => {
                        ...
                        console.log(data);
                            $('#pid').val(mid);
                        data.forEach(mat => {
                            $('#p-code').val(mat.Product_Code);
                            $('#p-name').val(mat.Product_Name);
                            $('#p-description').val(mat.Description);
                            $('#s-price').val(mat.supplier_price);
                            $('#p-srp').val(mat.srp);
                            // select2("val", "0");
                            // $('#supplier-id :selected').val(mat.supplier);
                            $('#supplier-id').select2("val", mat.supplier);
                            $('#p-unit').select2("val",mat.unit);

                            if (mat.product_image != null) {
                                $('#p-imgp').attr("src", mat.product_image);
                            }
                        });
                    })
