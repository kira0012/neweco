                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table
                                ...
                                @can('Inventory')
                                <td class="text-center"><a type="button" href="supplier/profile/{{$Supplier->id}}"
                                    ...
                                    <form action="/add-supplier" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="address">Address</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input class="form-control"  type="number" id="phoneno" name="phoneno" placeholder="Phone Number" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg 6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input class="form-control"  type="number" id="faxno" name="faxno" placeholder="Fax Number" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input class="form-control"  type="number" id="tinno" name="tinno" placeholder="Tin Number" >
                                                        </div>
                                                    </div>
