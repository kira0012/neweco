                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <h5 style="color:black;">Job Order Reports</h5>
                        </div>
                            <br/>
                            <h5 id="range"></h5>
                            ...
                            <div class="table-responsive">
                                <table>
                                        ...
                                        <tr class="top-line nb">
                                                <td colspan="4" class="text-center"><b>Gross Job Order</b></td>
                                                <td id="tamount">
                                        </tr>
        ...
        .then((res) => res.json())
            .then((data) =>{
                ...
                data.forEach(objso => {
                            ...
                            '<td><b>'+moneyFormat(objso.amount)+'</b></td>'+
                            '</tr>');
                             grossjo += Number(objso.amount);
                             jocost += Number(objso.cost);
                    ...
                    $('#tamount').empty();
                    $('#tamount').append('<b>'+moneyFormat(grossjo)+'</b>');   
