            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style">
                            <li>
                                <h4 class="page-title">Branch Remittance Report</h4>
                            </li>
                        </ul>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                         ...
                         <h5 style="color:black;">Remittance Reports</h5>
                        </div>
                            <br/>
                            <h5 id="range"></h5>
                        <div class="body">
                            <div class="table-responsive">
                                <table>
                                        ...
                                        <tbody id="tremits">
                                         ...
                                         <tr class="top-line nb" id="ttsale">
                                                <td colspan="2" class="text-center"><b>Total Remit</b></td>
                                                <td id="tamount">
                                                </td>
                                        </tr>
...
<script>
        window.onload = function () {
            $('.nav-reports').click();
            $('.nav-remit-reports').click();
            $('.nav-branch-sale').addClass('active');
...
$('#view-content').on('click', function(){
    ...
    $('#range').empty();
    $('#range').append('Remittance Summary From '+from+' To '+to);
        ...
        .then((res) => res.json())
            .then((remits) =>{
                ...
                remits.forEach(objremit => {
                    $('#tremits').append('<tr class="nb">'+
                            '<td></td>'+
                            '<td>'+objremit.store_name+'</td>'+
                            '<td>'+moneyFormat(objremit.total_amount)+'</td>'+
                            '</tr>');
                             totalremits += Number(objremit.total_amount);
                    })
                    $('#tamount').empty();
                    $('#tamount').append(moneyFormat(totalremits));   
