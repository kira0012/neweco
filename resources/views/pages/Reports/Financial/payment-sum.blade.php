                    ...
                    <div class="card">
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <center>
                                        <h3 class ="dr-title" style="color:black;">Order Payment Summary</h3>
                                    </center>
                                    <Br/>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                    <table class="table tb-content">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                              <td class="text-center" style="width:30%">{{$payment->payment_date}}</td>
                                              <td class="text-center" style="width:20%">{{$payment->payment_desc}} </td>

                                                @if ($payment->payment_desc == 'Cheque')
                                                <td class="text-left" style="width:50%">{{$payment->Remarks}}/ Cheque Details - {{$payment->checkno}}</td>
                                               

                                                @elseif ($payment->payment_desc == 'Direct Deposit')
                                                 <td class="text-left" style="width:50%">{{$payment->Remarks}} / {{$payment->depositTobank->bank}} / {{$payment->depositTobank->bank_account}}</td>
                                               
                                                @else
                                                <td class="text-left" style="width:50%">{{$payment->Remarks}}</td>
                                                @endif
                                              ...
                                              <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($order->payments->sum('amount'))}}</td>
                                                 
                                              </tr>
                                              <tr>       
                                                                      
                                                    <td class="text-right" colspan="3"><b>Order Amount:</b></td>
                                                    <td class="text-right">{{number_format($order->total_amount)}}</td>
                                              </tr>
                                              <tr>       
                                                                        
                                                    <td class="text-right" colspan="3"><b>Total Balance:</b></td>
                                                    <td class="text-right">{{number_format($order->total_amount - $order->payments->sum('amount'))}}</td>
                                              </tr>
                                            </tbody>
