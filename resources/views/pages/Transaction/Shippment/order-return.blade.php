            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <div class="row">
                            <div class="col-lg-6">
                                    <h2><strong>Orders Details</strong></h2>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="body">
                        <div class="row">
                        <div class="col-lg-6">
                            <h6><strong>Customer :</strong> {{$Orders['0']['business_name'] == null ? $Orders['0']['name'] : $Orders['0']['business_name'] }}</h6>
                            <h6><strong>Contact Number :</strong> {{$Orders['0']['phoneno'] }} / {{$Orders['0']['contactno']}}</h6>
                            <h6><strong>Address :</strong> {{$Orders['0']['address'] }}</h6>
                            
                        </div>
                        <div class="col-lg-6">
                                <h6><strong>Order Date :</strong> {{$Orders['0']['order_date'] }}</h6>
                                <h6><strong>Total Amount :</strong> {{$Orders['0']['total_amount'] }}</h6>
                            </div>
                        </div>
