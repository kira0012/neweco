                    ...
                    <div class="card">
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <center>
                                        <h3 class ="dr-title" style="color:black;">Job Order Payment Details</h3>
                                    </center>
                                    <Br/>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                    <table class="table tb-content">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        <td class="text-center">Job Order No:</td>
                                                        <td class="text-center"><b>Jo-{{str_pad($transaction->jo_id,8,"0",STR_PAD_LEFT)}}</b></td>
                                                        <td class="text-center">500</td>
                                                        <td class="text-center">{{ isset($denomination->ca500) != null ? $denomination->ca500 : '0'}}</td>
                                                </tr>
                                                <tr>
                                                        <td class="text-center" >Job Order Category</td>
                                                        <td class="text-center" ><b>{{$job_order->job_category->category}}</b></td>
                                                ...
                                                <tr>    
                                                        ...
                                                        <td class="text-center"><b>{{ $transaction->bank_id != null ? $transaction->jo_deposit->bank .' / '. $transaction->jo_deposit->bank_account : ' '}}</b></td>
